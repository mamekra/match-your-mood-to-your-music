...
df = pd.read_csv('C:/Users/user/Documents/ΠΜΣ DWS/NLP/project/cleaned_songs.csv', nrows=100000)
OUTPUT_PATH = 'C:/Users/user/Documents/ΠΜΣ DWS/NLP/project/labeled_songs.csv'
