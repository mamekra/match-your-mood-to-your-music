...
DATASET_PATH = 'C:/Users/user/Documents/ΠΜΣ DWS/NLP/project/song_lyrics_subset.csv'  # Replace with the actual path to your dataset
OUTPUT_PATH = 'C:/Users/user/Documents/ΠΜΣ DWS/NLP/project/cleaned_songs.csv'  # Path to save the cleaned dataset
